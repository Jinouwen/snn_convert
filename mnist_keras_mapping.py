...
Input, Model = keras.Input, keras.Model
...
path_wd = os.path.abspath('/mnt/ouwen/pycharm_project_000/keras_mapping')
try:
    os.makedirs(path_wd)
except:
    pass
...
if opt == 0:
    ...
    config['simulation'] = {
        'simulator': 'mapping',               # Time resolution for ODE solving.
    }
